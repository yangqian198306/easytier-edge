/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e6cc7e3988b316017a3324922dc93196)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	MAX_FRAME_BYTES: "1048576";
	EASYTIER_SERVER: DurableObjectNamespace<import("./src/index").EasyTierServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EasyTierServer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_FRAME_BYTES">> {}
}
